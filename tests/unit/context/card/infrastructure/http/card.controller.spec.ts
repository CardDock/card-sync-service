...
import { CardController } from '../../../../../../src/context/card/infrastructure/http/card.controller';
...
import { UpdateCardUseCase } from '../../../../../../src/context/card/application/use-cases/update-card.use-case';
import { SetCardTranslationUseCase } from '../../../../../../src/context/card/application/use-cases/set-card-translation.use-case';
import { AddCardArtworkUseCase } from '../../../../../../src/context/card/application/use-cases/add-card-artwork.use-case';
  ...
  describe('PATCH /cards/:id', () => {
    ...
    it('propagates CardDomainProcessError from use case', async () => {
      const { CardDomainProcessError } =
        await import('../../../../../../src/context/card/domain/errors');
      const mocks = buildUseCaseMocks();
